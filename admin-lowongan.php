            ...
            <li class="notification-dropdown">
              <div class="notification-menu" id="adminNotificationMenu">
                ...
                <div class="notification-footer">
                  <a href="admin-notifications.php" id="viewAllAdminNotifications">Lihat Semua Notifikasi</a>
                </div>
              </div>
            </li>

            <li>
              <button class="btn btn-primary" id="sendNotificationBtn"><i class="fas fa-paper-plane"></i> Kirim Notifikasi</button>
            </li>
