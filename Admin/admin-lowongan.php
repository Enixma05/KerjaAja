...
<body>
    ...
    document.addEventListener("DOMContentLoaded", function() {
                ...
                searchInput.addEventListener("input", function() {
                    ...
                    const filteredJobs = mockAdminJobs.filter((job) => job.title.toLowerCase().includes(
                            searchTerm) || job.company.toLowerCase().includes(searchTerm) || job.location
                    ...
                    addJobBtn.addEventListener("click", function() {
                        ...
                        modalDescription.textContent =
                            "Isi form berikut untuk menambahkan lowongan kerja baru";
                        jobForm.reset();
                        jobIdInput.value = "";
                    ...
                    jobForm.addEventListener("submit", function(e) {
                        ...
                        // Validate form
                        if (!titleInput.value || !companyInput.value || !locationInput.value || !
                            deadlineInput.value || !descriptionInput.value) {
