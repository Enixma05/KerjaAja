                            ...
                            <table class="data-table" id="jobApplicantTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($pelamar['judul']) ?></td>
                                        <td><?= htmlspecialchars($pelamar['perusahaan']) ?></td>
                                        <td><?= date("d/m/Y", strtotime($pelamar['tanggal_lamar'])) ?></td>
                                        <td><a href="<?= htmlspecialchars($pelamar['path_cv']) ?>" target="_blank">Lihat
                                                CV</a></td>
                                        <td><?= htmlspecialchars($pelamar['status']) ?></td>
                                        <td class="text-right">
                                            <form action="update_status_lamaran.php" method="post"
                                    ...
                                    <?php else: ?>
                                    <tr>
                                        <td colspan="7" style="text-align:center;">Belum ada data pelamar.</td>
                                    </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
